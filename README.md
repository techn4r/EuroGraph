# Проект: Анализ и обработка графа европейских стран

## Описание проекта

Данный проект реализует серию алгоритмов для работы с графами, используя данные о европейских странах и их границах. Основное внимание уделял построению и анализу графа, в котором:
